...
da API precisam estar bem definidas e validadas, então crie um documento usando a especificação RAML 1.0, que dê norte
...
A API deve usar autenticação com Token JWT.
